...
#' 
#' @description 
#' A function summarizing posterior inference of a \code{synergysplines} object.
#' 
#' @param object The fitted model to summarise, from \code{\link{synergysplines}}.
...
summary.synergysplines <- function(object,...){
